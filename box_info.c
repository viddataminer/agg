...
int try_snmp_system(char *node_ip,char *os_type, char *hostname, char *commstr)
{
    ...
    char *comm_strs[10]={"1xR\\$bluE", "99U#u#U\\!x", "oc12fast", "public", ""}, comm_str[100], **check_strs;
...
#define FAILURE 666
    ...
    if(g_use_command_line_comm_strs) check_strs = g_comm_strs;
    else check_strs = comm_strs;
/*
