...
int open_log_file(char *pname)
{
    ...
    if(!(ptr=(char *)strchr(ptr,'/'))) {
        ...
        sprintf(les_file_with_path,"%s/%s.les",LES_PATH, prog_name);
        sprintf(tmp_file_with_path,"%s/%s.tmp",LES_PATH, prog_name);
        strcpy(raw_app_name, prog_name);
        sprintf(bk_filename_with_path,"%s/%s.log.bk",
                LOG_PATH, prog_name);
    } else {
        ...
        sprintf(les_file_with_path,"%s/%s.les",LES_PATH,raw_app_name);
        sprintf(tmp_file_with_path,"%s/%s.tmp",LES_PATH,raw_app_name);
        sprintf(bk_filename_with_path,"%s/%s.log.bk",
                LOG_PATH, raw_app_name);
    }
